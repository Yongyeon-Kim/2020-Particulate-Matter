...
# 데이터 불러오기
daily_air = pd.read_csv('/home/kyy/2023_고급웹프로그래밍/data_analysis/Traffic&PM/data/2018_daily_air_quality.csv')
daily_traffic = pd.read_csv('/home/kyy/2023_고급웹프로그래밍/data_analysis/Traffic&PM/data/2018_daily_traffic.csv')
